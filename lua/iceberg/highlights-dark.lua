...
function M.set_highlights()
    ...
    hl(0, "Cursor", { fg = "#161822", bg = "#5d3449" })
    hl(0, "CursorLineNr", { fg = "#cfd3e8", bg = "#1f2233" })
    ...
    hl(0, "TelescopeResultsNormal", { bg = "" })
    hl(0, "TelescopePromptNormal", { bg = "" })
    hl(0, "TelescopePreviewNormal", { bg = "" })
    ...
    hl(0, "@lsp.type.parameter.javascript", { link = "@variable.parameter" })

    hl(0, "@variable.builtin", { link = "Statement" })
    hl(0, "@variable", { link = "icebergNormalFg" })
    hl(0, "@variable.parameter", { link = "Orange" })
