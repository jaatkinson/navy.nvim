-- navy.nvim dark highlights. Originally generated by huey; now hand-maintained.
...
function M.set_highlights()
    ...
    hl(0, "CursorLineNr", { fg = "#cfd3e8", bg = "NONE" })
    ...
    hl(0, "FloatBorder", { fg = "#3e4757", bg = "NONE" })
    ...
    hl(0, "BlinkCmpKind", { link = "@variable.parameter" })
    ...
    hl(0, "TelescopePreviewBorder", { fg = "#5d3449" })
    hl(0, "TelescopeBorder", { fg = "#5d3449" })
    hl(0, "TelescopePromptBorder", { fg = "#5d3449" })
    hl(0, "TelescopeResultsBorder", { fg = "#5d3449" })
    ...
    hl(0, "@variable.parameter", { fg = "#9e588f" })
    hl(0, "@variable.member.javascript", { fg = "#f8f6ff", bg = "NONE"})
    ...
    hl(0, "WinSeparator", { fg = "#3e4757", bg = "NONE" })

    hl(0, "SnacksIndentScope", { fg = "#5d3449" })
    hl(0, "SnacksIndent", { fg = "#2e3440" })

    -- gitsigns.nvim
    hl(0, "GitSignsAdd", { fg = "#b5bf82", bg = "NONE" })
    hl(0, "GitSignsChange", { fg = "#89b9c2", bg = "NONE" })
    hl(0, "GitSignsDelete", { fg = "#e27878", bg = "NONE" })
    hl(0, "GitSignsChangedelete", { fg = "#89b9c2", bg = "NONE" })
    hl(0, "GitSignsTopdelete", { fg = "#e27878", bg = "NONE" })
    hl(0, "GitSignsUntracked", { fg = "#6c7189", bg = "NONE" })
    ...
    -- which-key.nvim
    hl(0, "WhichKey", { fg = "#e2a578", bg = "NONE" })
    hl(0, "WhichKeyGroup", { fg = "#85a0c7", bg = "NONE" })
    hl(0, "WhichKeyDesc", { fg = "#c7c9d1", bg = "NONE" })
    hl(0, "WhichKeySeparator", { fg = "#6c7189", bg = "NONE" })
    hl(0, "WhichKeyValue", { fg = "#6c7189", bg = "NONE" })
    hl(0, "WhichKeyFloat", { link = "NormalFloat" })
    hl(0, "WhichKeyBorder", { link = "FloatBorder" })
    hl(0, "WhichKeyTitle", { link = "FloatTitle" })

    -- noice.nvim
    hl(0, "NoiceCmdlineIcon", { fg = "#e2a578", bg = "NONE" })
    hl(0, "NoiceCmdlinePopupTitle", { link = "FloatTitle" })
    hl(0, "NoiceCmdlinePopupBorder", { link = "FloatBorder" })
    hl(0, "NoiceConfirmBorder", { link = "FloatBorder" })
    hl(0, "NoicePopupBorder", { link = "FloatBorder" })
    hl(0, "NoiceMini", { link = "Comment" })
    hl(0, "NoiceVirtualText", { fg = "#6c7189", bg = "NONE" })

    -- nvim-notify
    hl(0, "NotifyERRORBorder", { fg = "#e27878", bg = "NONE" })
    hl(0, "NotifyERRORIcon", { fg = "#e27878", bg = "NONE" })
    hl(0, "NotifyERRORTitle", { fg = "#e27878", bg = "NONE" })
    hl(0, "NotifyWARNBorder", { fg = "#e2a578", bg = "NONE" })
    hl(0, "NotifyWARNIcon", { fg = "#e2a578", bg = "NONE" })
    hl(0, "NotifyWARNTitle", { fg = "#e2a578", bg = "NONE" })
    hl(0, "NotifyINFOBorder", { fg = "#89b9c2", bg = "NONE" })
    hl(0, "NotifyINFOIcon", { fg = "#89b9c2", bg = "NONE" })
    hl(0, "NotifyINFOTitle", { fg = "#89b9c2", bg = "NONE" })
    hl(0, "NotifyDEBUGBorder", { fg = "#6c7189", bg = "NONE" })
    hl(0, "NotifyDEBUGIcon", { fg = "#6c7189", bg = "NONE" })
    hl(0, "NotifyDEBUGTitle", { fg = "#6c7189", bg = "NONE" })
    hl(0, "NotifyTRACEBorder", { fg = "#a093c8", bg = "NONE" })
    hl(0, "NotifyTRACEIcon", { fg = "#a093c8", bg = "NONE" })
    hl(0, "NotifyTRACETitle", { fg = "#a093c8", bg = "NONE" })
    ...
    -- trouble.nvim
    hl(0, "TroubleText", { fg = "#c7c9d1", bg = "NONE" })
    hl(0, "TroubleCount", { fg = "#c58bb5", bg = "NONE", bold = true })
    hl(0, "TroubleNormal", { link = "NormalFloat" })
    hl(0, "TroubleNormalNC", { link = "NormalFloat" })
    hl(0, "TroubleLocation", { fg = "#6c7189", bg = "NONE" })
    hl(0, "TroubleSource", { fg = "#6c7189", bg = "NONE" })
    hl(0, "TroubleFoldIcon", { fg = "#e2a578", bg = "NONE" })
    hl(0, "TroubleIndent", { fg = "#3e4757", bg = "NONE" })

    -- flash.nvim
    hl(0, "FlashBackdrop", { fg = "#6c7189", bg = "NONE" })
    hl(0, "FlashMatch", { link = "Search" })
    hl(0, "FlashCurrent", { link = "IncSearch" })
    hl(0, "FlashLabel", { fg = "#392313", bg = "#e4aa81", bold = true })
    ...
    -- family. These are set without { default = true } so they win over the
    -- plugin's fallback links.
    hl(0, "SuitecloudScripts", { fg = "#85a0c7", bold = true })
    hl(0, "SuitecloudSearches", { fg = "#89b9c2", bold = true })
    hl(0, "SuitecloudCustomRecords", { fg = "#e2a578", bold = true })
    hl(0, "SuitecloudLists", { fg = "#b5bf82", bold = true })
    hl(0, "SuitecloudWorkflows", { fg = "#a093c8", bold = true })
    hl(0, "SuitecloudAdvancedPDF", { fg = "#c58bb5", bold = true })
