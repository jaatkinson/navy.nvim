-- navy.nvim light highlights. Originally generated by huey; now hand-maintained.
-- Note: the navy/red fork customisations are dark-only; this remains close to
-- the upstream iceberg light theme, with the NetSuite groups added below.
...
function M.set_highlights()
    ...
    -- gitsigns.nvim
    hl(0, "GitSignsAdd", { fg = "#668f3d", bg = "NONE" })
    hl(0, "GitSignsChange", { fg = "#3f84a6", bg = "NONE" })
    hl(0, "GitSignsDelete", { fg = "#cd517a", bg = "NONE" })
    hl(0, "GitSignsChangedelete", { fg = "#3f84a6", bg = "NONE" })
    hl(0, "GitSignsTopdelete", { fg = "#cd517a", bg = "NONE" })
    hl(0, "GitSignsUntracked", { fg = "#8489a4", bg = "NONE" })
    ...
    -- which-key.nvim
    hl(0, "WhichKey", { fg = "#c67439", bg = "NONE" })
    hl(0, "WhichKeyGroup", { fg = "#2e539e", bg = "NONE" })
    hl(0, "WhichKeyDesc", { fg = "#33374d", bg = "NONE" })
    hl(0, "WhichKeySeparator", { fg = "#8489a4", bg = "NONE" })
    hl(0, "WhichKeyValue", { fg = "#8489a4", bg = "NONE" })
    hl(0, "WhichKeyFloat", { link = "NormalFloat" })
    hl(0, "WhichKeyBorder", { link = "FloatBorder" })
    hl(0, "WhichKeyTitle", { link = "FloatTitle" })

    -- noice.nvim
    hl(0, "NoiceCmdlineIcon", { fg = "#c67439", bg = "NONE" })
    ...
    hl(0, "NoiceVirtualText", { fg = "#8489a4", bg = "NONE" })

    -- nvim-notify
    hl(0, "NotifyERRORBorder", { fg = "#cd517a", bg = "NONE" })
    hl(0, "NotifyERRORIcon", { fg = "#cd517a", bg = "NONE" })
    hl(0, "NotifyERRORTitle", { fg = "#cd517a", bg = "NONE" })
    hl(0, "NotifyWARNBorder", { fg = "#c67439", bg = "NONE" })
    hl(0, "NotifyWARNIcon", { fg = "#c67439", bg = "NONE" })
    hl(0, "NotifyWARNTitle", { fg = "#c67439", bg = "NONE" })
    hl(0, "NotifyINFOBorder", { fg = "#3f84a6", bg = "NONE" })
    hl(0, "NotifyINFOIcon", { fg = "#3f84a6", bg = "NONE" })
    hl(0, "NotifyINFOTitle", { fg = "#3f84a6", bg = "NONE" })
    hl(0, "NotifyDEBUGBorder", { fg = "#8489a4", bg = "NONE" })
    hl(0, "NotifyDEBUGIcon", { fg = "#8489a4", bg = "NONE" })
    hl(0, "NotifyDEBUGTitle", { fg = "#8489a4", bg = "NONE" })
    hl(0, "NotifyTRACEBorder", { fg = "#785ab5", bg = "NONE" })
    hl(0, "NotifyTRACEIcon", { fg = "#785ab5", bg = "NONE" })
    hl(0, "NotifyTRACETitle", { fg = "#785ab5", bg = "NONE" })
    ...
    -- trouble.nvim
    hl(0, "TroubleText", { fg = "#33374d", bg = "NONE" })
    hl(0, "TroubleCount", { fg = "#785ab5", bg = "NONE", bold = true })
    hl(0, "TroubleNormal", { link = "NormalFloat" })
    hl(0, "TroubleNormalNC", { link = "NormalFloat" })
    hl(0, "TroubleLocation", { fg = "#8489a4", bg = "NONE" })
    hl(0, "TroubleSource", { fg = "#8489a4", bg = "NONE" })
    hl(0, "TroubleFoldIcon", { fg = "#c67439", bg = "NONE" })
    hl(0, "TroubleIndent", { fg = "#c1c4d6", bg = "NONE" })

    -- flash.nvim
    hl(0, "FlashBackdrop", { fg = "#8489a4", bg = "NONE" })
    hl(0, "FlashMatch", { link = "Search" })
    hl(0, "FlashCurrent", { link = "IncSearch" })
    hl(0, "FlashLabel", { fg = "#86522d", bg = "#ebc7ad", bold = true })
    hl(0, "FlashPrompt", { link = "Normal" })
    hl(0, "FlashPromptIcon", { fg = "#c67439", bg = "NONE" })

    -- NetSuite scriptId groups (suitecloud.nvim), light variant.
    hl(0, "SuitecloudScripts", { fg = "#2e539e", bold = true })
    hl(0, "SuitecloudSearches", { fg = "#3f84a6", bold = true })
    hl(0, "SuitecloudCustomRecords", { fg = "#c67439", bold = true })
    hl(0, "SuitecloudLists", { fg = "#668e3d", bold = true })
    hl(0, "SuitecloudWorkflows", { fg = "#785ab5", bold = true })
    hl(0, "SuitecloudAdvancedPDF", { fg = "#9c4f86", bold = true })
    hl(0, "SuitecloudBodyFields", { fg = "#5764a2", italic = true })
    hl(0, "SuitecloudColumnFields", { fg = "#3f6f86", italic = true })
    hl(0, "SuitecloudEntityFields", { fg = "#6a5a9e", italic = true })
    hl(0, "SuitecloudItemFields", { fg = "#3f6a86", italic = true })
    hl(0, "SuitecloudCrmFields", { fg = "#6f5a9e", italic = true })
    hl(0, "SuitecloudOtherFields", { fg = "#5a5f93", italic = true })
end
